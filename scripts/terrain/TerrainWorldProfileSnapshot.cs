...
public sealed class TerrainWorldProfileSnapshot
{
    ...
    public int LastDeformVisibleCommitCount { get; init; }
    public int LastDeformSeamRefreshCount { get; init; }
    ...
    public double LastDeformVisibleConvergenceMs { get; init; }
    ...
    public int VisibleEditedStickyRegionCount { get; init; }
    public int VisibleEditedBlockCount { get; init; }
    public int VisibleEditedFinestBlockCount { get; init; }
    public int VisibleEditedLaggingBlockCount { get; init; }
    public string VisibleEditedBlockSummary { get; init; } = string.Empty;
    ...
    public int NearPlayerBubbleParentCount { get; init; }
    public int RefinedParentCount { get; init; }
    public int RefinedSameLodBlockCount { get; init; }
    ...
    public double BlockSetChangeRatePerSecond { get; init; }
    public long RefinementHandoffCount { get; init; }
    public long ReleaseDeferralsHysteresisCount { get; init; }
    ...
    public long ReleaseRequeueCount { get; init; }
    public int LastReleaseRequeueCount { get; init; }
    public long ReleaseHeadOfLineAvoidedCount { get; init; }
    public int LastReleaseHeadOfLineAvoidedCount { get; init; }
    public double AverageReleaseDeferredAgeMs { get; init; }
    public double LastAverageReleaseDeferredAgeMs { get; init; }
    public int ActiveSupersededBlockTransitionCount { get; init; }
    public int WaitingForMarkReleasableSupersededBlockCount { get; init; }
    public int WaitingForVisualCoverageSupersededBlockCount { get; init; }
